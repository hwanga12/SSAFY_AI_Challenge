...
본 프로젝트는 **SSAFY 14기 AI 챌린지**의 일환으로, 이미지와 자연어 질문을 동시에 이해하여 보기(a, b, c, d) 중 정답을 선택하는 **VQA (Visual Question Answering) 모델**을 개발하는 것을 목표로 함.

VQA 모델은 이미지 속 상황과 객체를 '이해'하고 논리적으로 '답변'하는 **멀티모달 AI의 핵심 기술**입니다. 저희는 이 챌린지를 통해 최신 멀티모달 모델의 작동 원리를 이해하고 실제 서비스에 적용 가능한 AI 모델을 구축하는 경험을 했습니다.
...
      <td rowspan="7">아래 4.1 최적화 근거 참고</td>
    </tr>
    <tr>
      <td>모델 채택</td>
      <td>(초기 모델)</td>
...
## 4.1 최적화 근거 (Optimization Rationale)
...
* **팀 정확도 0.75 -> 0.94 최종 순위 Top 50 달성** 정확도 약 25% 상승 및 팀 최종 순위 Top 50 달성

* ![demo](assets/image%20(1).png) (중간 과정)
* ![demo](assets/image%20(2).png)
