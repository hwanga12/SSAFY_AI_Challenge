...
VQA 모델은 이미지 속 상황과 객체를 '이해'하고 논리적으로 '답변'하는 **멀티모달 AI의 핵심 기술**. 
본 챌린지를 통해 최신 멀티모달 모델의 작동 원리를 이해하고 실제 서비스에 적용 가능한 AI 모델 구축 경험을 쌓음.
...
* **학습 범위 확장:** 안정적인 수렴을 위해 Epoch을 1회에서 **5회**로 대폭 증가시키고, **200개 데이터셋 샘플 제한**을 해제하여 전체 데이터를 활용, 모델의 일반화 성능을 높임.
